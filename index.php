<?php 
  $config = [
    ...
    "143913265" => [
      "image" => "smoothestman",
      "title" => "SUBRO’S SMOOTHEST MAN"
    ],
    "143776503" => [
      "image" => "supercharger",
      "title" => "WILBER SUPER CHARGER"
    ],
    "137425791" => [
      "image" => "5khaos",
      "title" => "WILBER 5KHAOS"
...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <style>
            ...
            .embed-container { position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; margin-top: 2em;} .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }
    ...
    <div class="container">
      ...
      <div class="video-item-container">
          ...
          foreach($config as $vimeo_uri => $clip) {

          ?>

          <a class="video-item" href="#<?php echo $vimeo_uri; ?>" data-vimeo-uri="<?php echo $vimeo_uri; ?>">
            <img src="img/videos/<?php echo $clip['image']; ?>.jpg" alt="" class="video-item__image">
            <span class="video-item__title"><?php echo $clip['title']; ?></span>
          </a>
        ...
        var module = (function(ga, videoHash){
          ...
          var bindUIElements = function() {
            el.$video_items.on('click', handleVideoClick);
          };
          ...
          var loadHashedVideo = function() {
            var vimeo_uri = location.hash;
            if(vimeo_uri === "") return false;
            showVideo(vimeo_uri.substr(1));
          };
